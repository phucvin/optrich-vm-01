...
TARGETS = test_lexer test_parser test_store test_integration test_array test_multi_module test_span
...
test_span: tests/test_memory_span.cpp src/MemoryStore.o
	$(CXX) $(CXXFLAGS) tests/test_memory_span.cpp src/MemoryStore.o -o test_span
